...
## Project objective ##
The code run_analysis.R aims at executing five specific operations (described below) on a data set collected from the accelerometers from the Samsung Galaxy S smartphone, and made available on the [UCI Machine Learning website](http://archive.ics.uci.edu/ml/data sets/Human+Activity+Recognition+Using+Smartphones).
